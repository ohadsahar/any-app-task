...
export type Actions = GetAllTasks | GetAllTasksSuccess | GetAllTasksFailed |
  CreateTask | CreateTaskSuccess | CreateTaskFailed | DeleteTasks | DeleteTaskSuccess | DeleteTaskFailed;
